			...
			try {
				...
				try {
					...
					if (this.logger.isInfoEnabled()) {
						this.logger.info("More than one TaskExecutor bean found within the context, and none is named " +
				...
				try {
					...
					this.logger.info("No task executor bean found for async processing: " +
	...
	protected void handleError(Throwable ex, Method method, Object... params) throws Exception {
		if (Future.class.isAssignableFrom(method.getReturnType())) {
			...
			try {
				...
				this.logger.error("Exception handler for async method '" + method.toGenericString() +

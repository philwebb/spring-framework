...
/**
 * {@link BeanRegistrationCodeFragmentsCustomizer} for {@link ScopedProxyFactoryBean}.
 *
 * @author Stephane Nicoll
 * @author Phillip Webb
 * @since 6.0
 */
class ScopedProxyBeanRegistrationCodeFragmentsCustomizer implements BeanRegistrationCodeFragmentsCustomizer {
	...
	public BeanRegistrationCodeFragments customizeBeanRegistrationCodeFragments(RegisteredBean registeredBean,
		...
		return new ScopedProxyBeanRegistrationCodeFragments(codeFragments, registeredBean, targetBeanName,
	...
	private static class ScopedProxyBeanRegistrationCodeFragments extends BeanRegistrationCodeFragmentsWrapper {
		...
		public CodeBlock generateNewBeanDefinitionCode(GenerationContext generationContext, ResolvableType beanType,
			...
			return super.generateNewBeanDefinitionCode(generationContext, this.targetBeanDefinition.getResolvableType(),
		...
		public CodeBlock generateSetBeanDefinitionPropertiesCode(GenerationContext generationContext,
			...
			return super.generateSetBeanDefinitionPropertiesCode(generationContext, beanRegistrationCode,
					processedBeanDefinition, attributeFilter);
		}
		...
		public CodeBlock generateInstanceSupplierCode(GenerationContext generationContext,
			...
			GeneratedMethod method = beanRegistrationCode.getMethodGenerator()
					.generateMethod("get", "scopedProxyInstance").using(builder -> {
						...
						builder.addJavadoc("Create the scoped proxy bean instance for '$L'.",
						...
						builder.addStatement("$T factory = new $T()", ScopedProxyFactoryBean.class,
								ScopedProxyFactoryBean.class);
						builder.addStatement("factory.setTargetBeanName($S)", this.targetBeanName);
						builder.addStatement("factory.setBeanFactory($L.getBeanFactory())",

...
public class Compiled {
	 ...
	 * @throws IllegalStateException if the compiler wasn't passed exactly one file
	 */
	...
	/**
	 * Return a new instance of a compiled class of the given type. There must be only a
	 * single instance and it must have a default constructor.
	...
	/**
	 * Return an instance of a compiled class identified by its class name. The class must

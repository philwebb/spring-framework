...
class DefaultBeanRegistrationCodeFragments extends BeanRegistrationCodeFragments {
	...
	DefaultBeanRegistrationCodeFragments(BeanRegistrationsCode beanRegistrationsCode, RegisteredBean registeredBean,
	...
	protected CodeBlock generateValueCode(GenerationContext generationContext, String name, Object value) {
		...
		if (innerRegisteredBean != null) {
			...
			MethodReference generatedMethod = methodGenerator.generateBeanDefinitionMethod(generationContext,

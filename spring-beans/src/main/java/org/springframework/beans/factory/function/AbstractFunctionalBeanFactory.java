...
public abstract class AbstractFunctionalBeanFactory implements FunctionalBeanFactory {
	...
	@Override
	public <T> ObjectProvider<T> getBeanProvider(BeanSelector<T> selector) throws BeansException {
	...
	public <T> Class<?> getType(BeanSelector<T> selector) throws NoSuchBeanDefinitionException {
	...
	public String[] getBeanNamesForType(ResolvableType type, boolean includeNonSingletons, boolean allowEagerInit) {
		return getBeanNames(BeanSelector.byType(type, includeNonSingletons), allowEagerInit);
	}
	...
	public <T> Map<String, T> getBeans(BeanSelector<T> selector) throws BeansException {
		return getBeans(selector, true);
	}

	@Override
	public <T> String[] getBeanNames(BeanSelector<T> selector) {
		return getBeanNames(selector, true);
	}
	...
	public <A extends Annotation> A findAnnotationOnBean(String beanName, Class<A> annotationType)
		...
		MergedAnnotation<A> annotation = (type != null)
				? MergedAnnotations.from(type, SearchStrategy.TYPE_HIERARCHY).get(annotationType)

 ...
 * @see XBeanRepository
 */
public final class FunctionalBeanDefinition<T> implements OriginSupplier {
	...
	public FunctionalBeanDefinition<T> withUpdates(Consumer<Builder<T>> registration) {
		return build(new Builder<>(this), registration);
	}

	public static <T> FunctionalBeanDefinition<T> of(Consumer<Builder<T>> registration) {
		return build(new Builder<>(), registration);
	}

	private static <T> FunctionalBeanDefinition<T> build(Builder<T> builder,
			Consumer<Builder<T>> registration) {
		registration.accept(builder);
		return new FunctionalBeanDefinition<>(builder);
	}
	...
	public static class Builder<T> {
		...
		private Builder(FunctionalBeanDefinition<T> registration) {

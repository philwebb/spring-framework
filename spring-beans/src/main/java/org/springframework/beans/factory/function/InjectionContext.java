...
/**
 * Context object passed to bean {@link InstanceSupplier InstanceSuppliers} so
...
public interface InjectionContext {
	...
	/**
	 * Obtain a bean dependency to inject based on its name.
	 * <p>Behaves the same as {@link #getBean(String)}, but provides a measure
	 * of type safety by throwing a {@link BeanNotOfRequiredTypeException} if
	 ...
	 * Obtain a bean dependency to inject based on its name.
	 * <p>Behaves the same as {@link #getBean(String)}, but provides a measure
	 * of type safety by throwing a {@link BeanNotOfRequiredTypeException} if the
	 * bean is not of the required type
	 * @param <T> the bean type
	 * @param name the bean name
	 * @return the bean instance
	 * @throws BeanNotOfRequiredTypeException if the bean is not of the required type
	...
	/**
	 * Obtain a provider for the specified bean, allowing for lazy on-demand
	...
	/**
	 * Return the arguments explicitly passed to the
	 * {@link FunctionalBeanFactory} for use when creating the bean instance.
	 * @return the explicit arguments or {@code null} if not arguments were
	 * passed

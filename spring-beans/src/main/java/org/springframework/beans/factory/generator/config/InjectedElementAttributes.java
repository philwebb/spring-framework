...
public class InjectedElementAttributes {
	...
	/**
	 * Specify if the attributes have been resolved, or {@code null} to indicate
	 * that the injection should not happen.
	...
	/**
	 * Invoke the specified {@link Consumer} if this instance is
	 * {@link #isResolved() resolved}.
	...
	/**
	 * Return the resolved attributes at the specified index.

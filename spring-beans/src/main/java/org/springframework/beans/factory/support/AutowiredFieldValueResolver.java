...
/**
 * Resolver used to support the autowiring of fields. Typically used in AOT-processed
...
public final class AutowiredFieldValueResolver extends AutowiredElementResolver {
	...
	private Object resolveValue(RegisteredBean registeredBean, Field field) {
		...
		try {
			...
			Object value = ((AutowireCapableBeanFactory) beanFactory).resolveDependency(descriptor, beanName,

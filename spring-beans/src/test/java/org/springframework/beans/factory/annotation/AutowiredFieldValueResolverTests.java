...
class AutowiredFieldValueResolverTests {
	...
	void forFieldWhenFieldNameIsEmptyThrowsException() {
		...
		assertThatIllegalArgumentException().isThrownBy(() -> AutowiredFieldValueResolver.forField(""))
				.withMessage(message);
		assertThatIllegalArgumentException().isThrownBy(() -> AutowiredFieldValueResolver.forRequiredField(null))
				.withMessage(message);
		assertThatIllegalArgumentException().isThrownBy(() -> AutowiredFieldValueResolver.forRequiredField(" "))
				.withMessage(message);
	}
	...
	void resolveWhenFieldIsMissingThrowsException() {
		...
		assertThatIllegalArgumentException()
				.isThrownBy(() -> AutowiredFieldValueResolver.forField("missing").resolve(registeredBean))

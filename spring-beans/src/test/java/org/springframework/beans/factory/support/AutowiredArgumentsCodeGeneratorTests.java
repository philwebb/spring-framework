...
class AutowiredArgumentsCodeGeneratorTests {
	...
	void generateCodeWhenNoArguments() {
		...
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(UnambiguousMethods.class,
				method);
	...
	void generateCodeWhenMulitpleArguments() {
		Method method = ReflectionUtils.findMethod(UnambiguousMethods.class, "three", String.class, Integer.class,
				Boolean.class);
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(UnambiguousMethods.class,
				method);
	...
	void generateCodeWhenMulitpleArgumentsWithOffset() {
		...
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(Outer.Nested.class,
				constructor);
	...
	void generateCodeWhenAmbiguousConstructor() throws Exception {
		...
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(AmbiguousConstructors.class,
				constructor);
		assertThat(generator.generateCode(constructor.getParameterTypes()))
				.hasToString("args.get(0, java.lang.String.class), args.get(1, java.lang.Integer.class)");
	}
	...
	void generateCodeWhenUnambiguousConstructor() throws Exception {
		...
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(UnambiguousConstructors.class,
				constructor);
	...
	void generateCodeWhenAmbiguousSubclassMethod() {
		...
		AutowiredArgumentsCodeGenerator generator = new AutowiredArgumentsCodeGenerator(AmbiguousSubclassMethods.class,
				method);
		assertThat(generator.generateCode(method.getParameterTypes()))
				.hasToString("args.get(0, java.lang.String.class), args.get(1, java.lang.Integer.class)");
	}

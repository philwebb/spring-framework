...
public class BeanNameGenerationTests {
	...
	public void naming() {
		...
		GeneratedNameBean topLevel1 = (GeneratedNameBean) this.beanFactory.getBean(targetName);
		assertNotNull(topLevel1);

		targetName = className + BeanDefinitionReaderUtils.GENERATED_BEAN_NAME_SEPARATOR + "1";
		GeneratedNameBean topLevel2 = (GeneratedNameBean) this.beanFactory.getBean(targetName);

...
public class EventPublicationTests {
	...
	public void beanEventReceived() throws Exception {
		...
		assertThat((long) componentDefinition1.getBeanDefinitions().length).isEqualTo((long) 1);
		...
		assertThat((long) componentDefinition1.getBeanReferences().length).isEqualTo((long) 1);
		assertThat(componentDefinition1.getBeanReferences()[0].getBeanName()).isEqualTo("testBean2");
		assertThat((long) componentDefinition1.getInnerBeanDefinitions().length).isEqualTo((long) 1);
		...
		assertThat((long) componentDefinition2.getBeanReferences().length).isEqualTo((long) 0);
		assertThat((long) componentDefinition2.getInnerBeanDefinitions().length).isEqualTo((long) 1);
	...
	public void aliasEventReceived() throws Exception {
		...
		assertThat((long) aliases.size()).isEqualTo((long) 2);
	...
	public void importEventReceived() throws Exception {
		...
		assertThat((long) imports.size()).isEqualTo((long) 1);

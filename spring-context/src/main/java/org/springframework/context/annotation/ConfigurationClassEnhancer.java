...
class ConfigurationClassEnhancer {
	...
	private static final Callback[] CALLBACKS = new Callback[] {
		new BeanMethodInterceptor(), new DisposableBeanMethodInterceptor(),
	...
	/**
	 * A {@link CallbackFilter} that works by interrogating {@link Callback}s in the
	 * order that they are defined via {@link ConditionalCallback}.
	 */
	...
	/**
	 * Intercepts the invocation of any {@link DisposableBean#destroy()} on
	 * {@code @Configuration} class instances for the purpose of de-registering CGLIB
	 * callbacks. This helps avoid garbage collection issues See SPR-7901.
	...
	/**
	 * Intercepts the invocation of any {@link BeanFactoryAware#setBeanFactory(BeanFactory)}
	 * on {@code @Configuration} class instances for the purpose of recording the
	 * {@link BeanFactory}.
	 * @see EnhancedConfiguration
	 */

...
public interface ConfigurationCondition extends Condition {
	...
	/**
	 * The various configuration phases where the condition could be evalulated.
	 */
	public static enum ConfigurationPhase {

		/**
		 * The {@link Condition} should being tested as a {@code @Configuration} class is
		 * being parsed.
		 *
		...
		/**
		 * The {@link Condition} should be tested when adding a regular (non

 ...
 * represents the state of the bean factory, as well as the necessary hints that can be
 * used at runtime in a constrained environment.
 *
...
public class ApplicationContextAotGenerator {
	...
	/**
	 * Refresh the specified {@link GenericApplicationContext} and generate the necessary
	 * code to restore the state of its {@link BeanFactory}, using the specified
	 * {@link GenerationContext}.
	 * @param applicationContext the application context to handle
	 * @param generationContext the generation context to use
	 * @param generatedInitializerClassName the class name to use for the generated

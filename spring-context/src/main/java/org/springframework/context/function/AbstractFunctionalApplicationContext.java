...
public abstract class AbstractFunctionalApplicationContext
	...
	public <T> String[] getBeanNames(BeanSelector<T> selector, boolean allowEagerInit) {
		return getBeanFactory().getBeanNames(selector, allowEagerInit);
	}
	...
	@Override
	public <T> Map<String, T> getBeans(BeanSelector<T> selector, boolean allowEagerInit)
			throws BeansException {
		return getBeanFactory().getBeans(selector, allowEagerInit);
	}
	...
	@Override
	public FunctionalBeanDefinition<?> getBeanDefinition(String beanName)
			throws NoSuchBeanDefinitionException {

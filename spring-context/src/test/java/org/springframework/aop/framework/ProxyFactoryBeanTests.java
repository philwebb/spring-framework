...
public class ProxyFactoryBeanTests {
	...
	*/
	...
	public void testGlobalsCanAddAspectInterfaces() {
		...
		assertThatExceptionOfType(ClassCastException.class).as("Aspect interface should't be implemeneted without globals").isThrownBy(() -> {
			AddedGlobalInterface agi2 = (AddedGlobalInterface) factory.getBean("test1");
		});
	}

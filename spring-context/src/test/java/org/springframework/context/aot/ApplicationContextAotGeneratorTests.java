...
class ApplicationContextAotGeneratorTests {
	...
	void generateApplicationContextWhenHasAutowiring() {
		...
		applicationContext.registerBeanDefinition("number", BeanDefinitionBuilder
	...
	void generateApplicationContextWhenHasInitDestroyMethods() {
		GenericApplicationContext applicationContext = new GenericApplicationContext();
		applicationContext.registerBeanDefinition(AnnotationConfigUtils.COMMON_ANNOTATION_PROCESSOR_BEAN_NAME,
	...
	static class NoOpBeanRegistrationAotProcessor implements BeanPostProcessor, BeanRegistrationAotProcessor {

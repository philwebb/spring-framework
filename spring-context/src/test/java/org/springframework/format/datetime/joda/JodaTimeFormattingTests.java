...
public class JodaTimeFormattingTests {
	...
	public void testBindLocalDate() {
		...
		assertThat((long) binder.getBindingResult().getErrorCount()).isEqualTo((long) 0);
	...
	public void testBindLocalDateAnnotatedWithError() {
		...
		binder.bind(propertyValues);
		assertThat((long) binder.getBindingResult().getFieldErrorCount("localDateAnnotated")).isEqualTo((long) 1);
	...
	public void testBindDateTimeOverflow() {
		...
		binder.bind(propertyValues);
		assertThat((long) binder.getBindingResult().getErrorCount()).isEqualTo((long) 1);
	}
	...
	public void stringToDateWithGlobalFormat() {
		...
		Date date = this.conversionService.convert(string, Date.class);
		assertThat((Object) date).isNotNull();
	}

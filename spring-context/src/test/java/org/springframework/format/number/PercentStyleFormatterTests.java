...
public class PercentStyleFormatterTests {
	...
	public void formatValue() {
		assertEquals("23%", this.formatter.print(new BigDecimal(".23"), Locale.US));
	}

	@Test
	public void parseValue() throws ParseException {
		assertEquals(new BigDecimal(".2356"), this.formatter.parse("23.56%", Locale.US));
	}
	...
	public void parsePercentValueNotLenientFailure() throws ParseException {
		this.formatter.parse("23.56%bogus", Locale.US);
	}

...
public class MBeanClientInterceptorTests extends AbstractMBeanServerTests {
	...
	public void onSetUp() throws Exception {
		this.target = new JmxTestBean();
		this.target.setAge(100);
		this.target.setName("Rob Harrop");

		MBeanExporter adapter = new MBeanExporter();
		Map<String, Object> beans = new HashMap<>();
		beans.put(OBJECT_NAME, this.target);
	...
	public void testSetAttributeValue() throws Exception {
		...
		assertEquals("The name of the bean should have been updated", "Rob Harrop", this.target.getName());
	}

...
public enum AccessVisibility {
	...
	/**
	 * Determine the {@link AccessVisibility} for the given member. This method will
	...
	@Nullable
	private static AccessVisibility forResolvableType(ResolvableType resolvableType, Set<ResolvableType> seen) {
	...
	private static AccessVisibility forClass(Class<?> clazz) {

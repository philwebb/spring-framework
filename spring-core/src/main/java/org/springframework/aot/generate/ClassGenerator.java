...
public interface ClassGenerator {
	...
	/**
	 * Get or generate a new {@link GeneratedClass} for a given java file generator,
	 ...
	 */
	GeneratedClass getOrGenerateClass(JavaFileGenerator javaFileGenerator, Class<?> target, String featureName);
	 ...
	 * @return a {@link GeneratedClass} instance
	 */
	GeneratedClass getOrGenerateClass(JavaFileGenerator javaFileGenerator, String target, String featureName);

	/**
	 * Strategy used to generate the java file for the generated class. Implementations of
	 * this interface are included as part of the key used to identify classes that have
	 * already been created and as such should be static final instances or implement a
	 * valid {@code equals}/{@code hashCode}.
	 */
	@FunctionalInterface

 ...
 * all name generation. Most commonly the class name generator is obtained via
 * an {@link org.springframework.aot.context.AotContext AotContext}.
 *
...
public final class ClassNameGenerator {
	 ...
	 * @param name the name of the source item. Whenever possible this should be
	 * a target {@link Class}

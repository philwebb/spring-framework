...
public class GeneratedClasses implements ClassGenerator {
	...
	@Override
	public GeneratedClass getOrGenerateClass(JavaFileGenerator javaFileGenerator, Class<?> target, String featureName) {
		...
		return this.classes.computeIfAbsent(owner, key -> new GeneratedClass(javaFileGenerator,
				this.classNameGenerator.generateClassName(target, featureName)));
	}

	@Override
	public GeneratedClass getOrGenerateClass(JavaFileGenerator javaFileGenerator, String target, String featureName) {
		Assert.notNull(javaFileGenerator, "'javaFileGenerator' must not be null");
	...
	private record Owner(JavaFileGenerator javaFileGenerator, String target, String featureName) {

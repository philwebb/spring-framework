...
/**
 * Internal class used to support {@link MethodGenerator#withName(String)}.
 *
 ...
 * @since 6.0
 */
class NamedMethodGenerator implements MethodGenerator {
	...
	NamedMethodGenerator(MethodGenerator methodGenerator, Object[] nameParts) {

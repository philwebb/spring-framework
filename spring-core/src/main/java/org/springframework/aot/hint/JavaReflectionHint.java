...
public final class JavaReflectionHint implements ConditionalHint, Comparable<JavaReflectionHint> {
	...
	private static final Comparator<JavaReflectionHint> COMPARATOR = Comparator
	...
	@Override
	public int compareTo(JavaReflectionHint other) {
	...
	public abstract static class ExecutableHint {
		...
		ExecutableHint(Executable executable, ExecutableMode mode) {
			...
			this.mode = mode;
			this.parameterTypes = List.of(TypeReference.arrayOf(this.executable.getParameterTypes()));
		}

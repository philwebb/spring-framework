 ...
 * @since 6.0
 */
public final class ResourcePatternsHint {
	...
	private ResourcePatternsHint(Builder builder) {
	...
	/**
	 * Builder for {@link ResourcePatternsHint}.
	 */
	public static class Builder {
		...
		/**
		 * Creates a {@link ResourcePatternsHint} based on the state of this
		 * builder.
		 * @return a resource pattern hint
		 */
		ResourcePatternsHint build() {
			return new ResourcePatternsHint(this);
		}

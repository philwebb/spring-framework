...
public interface MergedAnnotation<A extends Annotation> {
	 ...
	 * one that is {@link #isMetaPresent() meta-present}.
	...
	/**
	 * Return the specified annotation is the same as, or a descendant of this
	 * annotation. An annotation is considered a descendant when it has been
	 * used as a meta-annotation on the specified annotation (either directly or
	 * inherited).
	 * @param annotation the annotation to check
	 * @return {@code true} if this annotation is a descendant
	 */
	boolean isDescendant(MergedAnnotation<?> annotation);

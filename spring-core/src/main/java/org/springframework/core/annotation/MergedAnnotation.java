...
public interface MergedAnnotation<A extends Annotation> {
	...
	static <A extends Annotation> MergedAnnotationFinder<MergedAnnotation<A>> find(
	...
	static <A extends Annotation> MergedAnnotationFinder<Set<MergedAnnotation<A>>> findAll(
			Class<A> annotationType) {
		return null;
	}

...
/**
 * An annotation directly declared on a {@link AnnotatedSource}. Similar to
 * Java's {@link Annotation} type, but may be backed by something that doesn't
...
public interface DeclaredAnnotation {
	...
	/**
	 * Create a new in-memory {@link DeclaredAnnotation} with the specific values.

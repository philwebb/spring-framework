...
/**
 * Converter that can convert a {@link ByteBuffer} via its bytes. This converter can
 * convert directly to and from {@code byte[]}s and indirectly to any type that
 * the {@link ConversionService} support via {@code byte[]}.
 *
 * @author Phillip Webb
 */

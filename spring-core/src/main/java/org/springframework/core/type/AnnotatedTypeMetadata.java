...
public interface AnnotatedTypeMetadata {
	...
	/**
	 * Determine whether the underlying method has an annotation or meta-annotation of the
	 * given type defined.
	 ...
	 * defined on the underlying type, as direct annotation or as meta-annotation).
	 * @param annotationType the annotation type to look for
	 * @return a Map of attributes, with the attribute name as key (e.g. "value") and the
	 *         defined attribute value as Map value. This return value will be

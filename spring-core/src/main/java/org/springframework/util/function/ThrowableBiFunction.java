...
public interface ThrowableBiFunction<T, U, R> extends BiFunction<T, U, R> {
	...
	/**
	 * Return a new {@link ThrowableBiFunction} where the
	 ...
	 */
	default ThrowableBiFunction<T, U, R> throwing(BiFunction<String, Exception, RuntimeException> exceptionWrapper) {
	 ...
	 */
	static <T, U, R> ThrowableBiFunction<T, U, R> of(ThrowableBiFunction<T, U, R> function) {
		return function;
	}

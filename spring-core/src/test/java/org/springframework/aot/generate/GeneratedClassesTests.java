...
class GeneratedClassesTests {
	...
	void getOrGenerateWithClassTargetWhenJavaFileGeneratorIsNullThrowsException() {
		assertThatIllegalArgumentException()
				.isThrownBy(() -> this.generatedClasses.getOrGenerateClass(null, TestTarget.class, "test"))
	...
	void getOrGenerateWithClassTargetWhenTargetIsNullThrowsException() {
		assertThatIllegalArgumentException()
				.isThrownBy(
						() -> this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR, (Class<?>) null, "test"))
	...
	void getOrGenerateWithClassTargetWhenFeatureIsNullThrowsException() {
		assertThatIllegalArgumentException()
				.isThrownBy(() -> this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class, null))
	...
	void getOrGenerateWithStringTargetWhenJavaFileGeneratorIsNullThrowsException() {
		assertThatIllegalArgumentException()
				.isThrownBy(() -> this.generatedClasses.getOrGenerateClass(null, TestTarget.class.getName(), "test"))
				.withMessage("'javaFileGenerator' must not be null");
	}
	...
	void getOrGenerateWithStringTargetWhenTargetIsNullThrowsException() {
		assertThatIllegalArgumentException()
				.isThrownBy(() -> this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR, (String) null, "test"))
	...
	void getOrGenerateWithStringTargetWhenFeatureIsNullThrowsException() {
		assertThatIllegalArgumentException().isThrownBy(
				() -> this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class.getName(), null))
				.withMessage("'featureName' must not be empty");
	}

	@Test
	void getOrGenerateWhenNewReturnsGeneratedMethod() {
		GeneratedClass generatedClass1 = this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class,
				"one");
		GeneratedClass generatedClass2 = this.generatedClasses.getOrGenerateClass(JAVA_FILE_GENERATOR,
				TestTarget.class.getName(), "two");
	...
	void getOrGenerateWhenRepeatReturnsSameGeneratedMethod() {
		...
		GeneratedClass generatedClass1 = generated.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class, "one");
		GeneratedClass generatedClass2 = generated.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class, "one");
		GeneratedClass generatedClass3 = generated.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class.getName(),
				"one");
		GeneratedClass generatedClass4 = generated.getOrGenerateClass(JAVA_FILE_GENERATOR, TestTarget.class, "two");

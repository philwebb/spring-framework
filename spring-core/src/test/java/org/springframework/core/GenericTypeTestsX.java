 ...
 * @author Sam Brannen
 */
public class GenericTypeTestsX {

	private GenericType mixedUpMapType;

	@Before
	public void setup() throws Exception {
		this.mixedUpMapType = GenericType.forField(getClass().getField("mixedUpMap"));
	}
	...
	public void shouldSupportWildcards() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("wildcard"));
	...
	public void shouldSupportBoundedWildcards() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("boundedWildcard"));
	...
	public void shouldKeepNestedGenerics() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("nested"));
	...
	public void shouldFindSuperType() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("multiValueMap")).get(Map.class);
	...
	public void shouldSupportGenericArrays() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("genericArray"));
	...
	public void shouldSupportArraySuperClass() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("genericArray")).getSuper();
	...
	public void shouldFindGenericOnArray() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("genericArray")).get(List.class);
	...
	public void shouldSupportVariablesOnArray() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("mixedUpMapArray"));
	...
	public void shouldSupportArrayInGeneric() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("arrayInGeneric"));
		assertThat(type.toString(), is("java.util.List<java.util.Set<java.lang.Integer>[]>"));
		assertThat(type.getGeneric(0).toString(), is("java.util.Set<java.lang.Integer>[]"));;
	...
	public void shouldSupportComplexNestedArrays() throws Exception {
		GenericType type = GenericType.forField(getClass().getField("complex"));
	...
	public void shouldSupportNoSuperclass() throws Exception {
		assertThat(GenericType.forClass(Object.class).getSuper(), is(GenericType.NONE));
	}

	@Test
	public void shouldSupportNoInterfaces() throws Exception {
		assertThat(GenericType.forClass(Object.class).getInterfaces().length, is(0));
	}

	@Test
	public void shouldSupportNoGenerics() throws Exception {
		assertThat(GenericType.forClass(Object.class).getGenerics().length, is(0));
	}
	...
	public void shouldResolveSimpleInterface() throws Exception {
		assertEquals(String.class, GenericType.forClass(MySimpleInterfaceType.class).get(MyInterfaceType.class).getGeneric(0).getTypeClass());
	}

	@Test
	public void shouldResolveCollectionInterface() throws Exception {
		assertEquals(Collection.class, GenericType.forClass(MyCollectionInterfaceType.class).get(MyInterfaceType.class).getGeneric(0).getTypeClass());
	}

	@Test
	public void shouldResolveSimpleSuperclass() throws Exception {
		assertEquals(String.class, GenericType.forClass(MySimpleSuperclassType.class).get(MySuperclassType.class).getGeneric(0).getTypeClass());
	}

	@Test
	public void shouldResolveSimpleCollectionSuperclass() throws Exception {
		assertEquals(Collection.class, GenericType.forClass(MyCollectionSuperclassType.class).get(MySuperclassType.class).getGeneric(0).getTypeClass());
	}

	@Test
	public void shouldReturnNullIfNotResolvable() throws Exception {
		GenericClass<String> obj = new GenericClass<String>();
		assertNull(GenericType.forClass(obj.getClass()).get(GenericClass.class).getGeneric(0).getTypeClass());
	}
	...
	public void testClassResolution() {
		assertEquals(String.class, GenericType.forClass(CustomSet.class).get(Collection.class).getGeneric(0).getTypeClass());
		assertEquals(String.class, GenericType.forClass(CustomMap.class).get(Map.class).getGeneric(0).getTypeClass());
		assertEquals(Integer.class, GenericType.forClass(CustomMap.class).get(Map.class).getGeneric(1).getTypeClass());
	}

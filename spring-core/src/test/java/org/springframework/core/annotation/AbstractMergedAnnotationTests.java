...
/**
 * Tests for {@link AbstractMergedAnnotation}.
 *
 * @author Phillip Webb
 */
public abstract class AbstractMergedAnnotationTests {
	...
	private MergedAnnotation<?> create(Object value, Class<?> type, Object defaultValue) {
	...
	protected abstract MergedAnnotation<?> create(AnnotationType annotationType,

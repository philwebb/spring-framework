...
public class MappableAnnotationTests {
	...
	public void getAnnotationTypeReturnsType() {
		...
		MappableAnnotation mappable = new MappableAnnotation(this.resolver, type,
	...
	public void fromAnnotationsIncludesAllAnnotations() {
		...
		Stream<String> mapped = MappableAnnotation.from(resolver, annotations).map(
				MappableAnnotation::getAnnotationType).map(AnnotationType::getClassName);

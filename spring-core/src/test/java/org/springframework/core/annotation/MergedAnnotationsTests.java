...
public class MergedAnnotationsTests {
	...
	private void testMissingTextAttribute(Map<String, Object> attributes) {
		assertThatExceptionOfType(NoSuchElementException.class).isThrownBy(() -> {
				MergedAnnotation<AnnotationWithoutDefaults> annotation = MergedAnnotation.from(AnnotationWithoutDefaults.class, attributes);
				annotation.synthesize();
			}).withMessage("No value found for attribute named 'text' in merged annotation " + AnnotationWithoutDefaults.class.getName());
	}

...
class ThrowableFunctionTests {
	...
	void applyWhenThrowingCheckedExceptionThrowsWrapperRuntimeException() {
		...
		assertThatExceptionOfType(RuntimeException.class).isThrownBy(() -> function.apply(this))
	...
	void applyWithExceptionWrapperWhenThrowingCheckedExceptionThrowsWrapper() {
		ThrowableFunction<Object, Object> function = this::throwIOException;
		assertThatIllegalStateException().isThrownBy(() -> function.apply(this, IllegalStateException::new))
			.withCauseInstanceOf(IOException.class);
	}
	...
	void throwingModifiesThrownException() {
		ThrowableFunction<Object, Object> function = this::throwIOException;
		ThrowableFunction<Object, Object> modified = function.throwing(IllegalStateException::new);
		assertThatIllegalStateException().isThrownBy(() -> modified.apply(this))
			.withCauseInstanceOf(IOException.class);
	}

	@Test
	void ofModifiesThrowException() {
		ThrowableFunction<Object, Object> function = ThrowableFunction.of(this::throwIOException, IllegalStateException::new);

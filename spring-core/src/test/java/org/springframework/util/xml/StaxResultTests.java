...
public class StaxResultTests {
	...
	public void streamWriterSource() throws Exception {
		...
		XMLStreamWriter streamWriter = this.inputFactory.createXMLStreamWriter(stringWriter);
	...
	public void eventWriterSource() throws Exception {
		StringWriter stringWriter = new StringWriter();
		XMLEventWriter eventWriter = this.inputFactory.createXMLEventWriter(stringWriter);
		Reader reader = new StringReader(XML);
		Source source = new StreamSource(reader);

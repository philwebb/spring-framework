...
public class SpelReproTests extends ExpressionTestCase {
	...
	public void SPR_10210() throws Exception {
		StandardEvaluationContext context = new StandardEvaluationContext();
		context.setVariable("bridgeExample", new BridgeD());
		Expression parseExpression = parser.parseExpression("#bridgeExample.methodName()");
	...
	public static interface BridgeC {
	}

	public static class BridgeB<T extends BridgeC> implements Serializable {
	}

	public static class BridgeA extends BridgeB<BridgeC> {
		public void methodName() {
			System.out.println("Called");
		}
	}

	public static class BridgeD extends BridgeA {
	}

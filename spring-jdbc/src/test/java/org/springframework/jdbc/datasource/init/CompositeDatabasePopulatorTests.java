...
public class CompositeDatabasePopulatorTests {
	...
	public void addPopulators() throws SQLException {
		...
		populator.addPopulators(this.mockedDatabasePopulator1, this.mockedDatabasePopulator2);
		populator.populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator1,times(1)).populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator2, times(1)).populate(this.mockedConnection);
	}

	@Test
	public void setPopulatorsWithMultiple() throws SQLException {
		CompositeDatabasePopulator populator = new CompositeDatabasePopulator();
		populator.setPopulators(this.mockedDatabasePopulator1, this.mockedDatabasePopulator2);  // multiple
		populator.populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator1, times(1)).populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator2, times(1)).populate(this.mockedConnection);
	}
	...
	public void setPopulatorsForOverride() throws SQLException {
		CompositeDatabasePopulator populator = new CompositeDatabasePopulator();
		populator.setPopulators(this.mockedDatabasePopulator1);
		populator.setPopulators(this.mockedDatabasePopulator2);  // override
		populator.populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator1, times(0)).populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator2, times(1)).populate(this.mockedConnection);
	}
	...
	public void constructWithVarargs() throws SQLException {
		CompositeDatabasePopulator populator =
				new CompositeDatabasePopulator(this.mockedDatabasePopulator1, this.mockedDatabasePopulator2);
		populator.populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator1, times(1)).populate(this.mockedConnection);
		verify(this.mockedDatabasePopulator2, times(1)).populate(this.mockedConnection);
	}
	...
	public void constructWithCollection() throws SQLException {
		...
		populators.add(this.mockedDatabasePopulator1);
		populators.add(this.mockedDatabasePopulator2);

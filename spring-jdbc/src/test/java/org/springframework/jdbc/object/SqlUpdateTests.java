...
public class SqlUpdateTests {
	...
	public void testUpdate() throws SQLException {
		...
		assertThat((long) rowsAffected).isEqualTo((long) 1);
	}
	...
	public void testUpdateAndGeneratedKeys() throws SQLException {
		...
		assertThat((long) rowsAffected).isEqualTo((long) 1);
		assertThat((long) generatedKeyHolder.getKeyList().size()).isEqualTo((long) 1);
		assertThat((long) generatedKeyHolder.getKey().intValue()).isEqualTo((long) 11);
		verify(preparedStatement).setString(1, "rod");
	...
	public void testUnderMaxRows() throws SQLException {
		...
		int rowsAffected = pc.run();
		assertThat((long) rowsAffected).isEqualTo((long) 3);
	}
	...
	public void testMaxRows() throws SQLException {
		...
		assertThat((long) rowsAffected).isEqualTo((long) 5);
	}

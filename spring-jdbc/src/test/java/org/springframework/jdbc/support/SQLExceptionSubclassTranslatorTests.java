...
public class SQLExceptionSubclassTranslatorTests {
	...
	public void errorCodeTranslation() {
		...
		assertThat((Object) divex.getCause()).isEqualTo(dataIntegrityViolationEx);
		...
		assertThat((Object) idaex.getCause()).isEqualTo(featureNotSupEx);
		...
		assertThat((Object) divex2.getCause()).isEqualTo(dataIntegrityViolationEx2);
		...
		assertThat((Object) pdaex.getCause()).isEqualTo(permissionDeniedEx);
		...
		assertThat((Object) darex.getCause()).isEqualTo(dataAccessResourceEx);
		...
		assertThat((Object) bsgex2.getSql()).isEqualTo("SQL2");
		...
		assertThat((Object) cfex.getCause()).isEqualTo(tranRollbackEx);
		...
		assertThat((Object) tdarex.getCause()).isEqualTo(transientConnEx);
		...
		assertThat((Object) tdarex2.getCause()).isEqualTo(transientConnEx2);
		...
		assertThat((Object) rdaex2.getCause()).isEqualTo(recoverableEx);
		...
		assertThat((Object) bsgEct.getSql()).isEqualTo("SQL-ECT");
		...
		assertThat((Object) bsgFbt.getSql()).isEqualTo("SQL-FBT");
		...
		assertThat((Object) darfFbt.getCause()).isEqualTo(sexFbt2);
	}

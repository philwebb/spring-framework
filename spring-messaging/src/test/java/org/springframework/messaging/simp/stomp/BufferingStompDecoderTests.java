...
public class BufferingStompDecoderTests {
	...
	public void basic() throws InterruptedException {
		...
		assertThat(stompDecoder.getBufferSize()).isEqualTo((long) 0);
	...
	public void twoMessagesInOneChunk() throws InterruptedException {
		...
		assertThat(messages.size()).isEqualTo((long) 2);
	...
	public void oneFullAndOneSplitMessageContentLength() throws InterruptedException {
		...
		assertThat(stompDecoder.getBufferSize()).isEqualTo((long) 23);
		assertThat((int) stompDecoder.getExpectedContentLength()).isEqualTo((long) contentLength);

		String chunk2 = "\nPayload2a";
		messages = stompDecoder.decode(toByteBuffer(chunk2));

		assertThat(messages.size()).isEqualTo((long) 0);
		assertThat(stompDecoder.getBufferSize()).isEqualTo((long) 33);
		assertThat((int) stompDecoder.getExpectedContentLength()).isEqualTo((long) contentLength);
	...
	public void oneFullAndOneSplitMessageNoContentLength() throws InterruptedException {
		...
		assertThat(stompDecoder.getBufferSize()).isEqualTo((long) 13);
		assertThat(stompDecoder.getExpectedContentLength()).isNull();
	...
	public void oneFullAndOneSplitWithContentLengthExceedingBufferSize() throws InterruptedException {
		...
		assertThat(messages.size()).as("We should have gotten the 1st message").isEqualTo((long) 1);
		assertThat(new String(messages.get(0).getPayload())).isEqualTo("Payload1");

		assertThat(stompDecoder.getBufferSize()).isEqualTo((long) 24);
		assertThat((int) stompDecoder.getExpectedContentLength()).isEqualTo((long) 129);

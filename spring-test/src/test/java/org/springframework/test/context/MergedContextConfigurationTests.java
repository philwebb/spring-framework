...
public class MergedContextConfigurationTests {
	...
	public void hashCodeWithNulls() {
		...
		assertThat((long) mergedConfig2.hashCode()).isEqualTo((long) mergedConfig1.hashCode());
	}
	...
	public void equalsBasics() {
		...
		assertThat(null).isNotEqualTo(mergedConfig);
		assertThat(1).isNotEqualTo(mergedConfig);
	}

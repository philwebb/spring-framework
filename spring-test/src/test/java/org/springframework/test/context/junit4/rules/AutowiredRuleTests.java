...
public class AutowiredRuleTests {
	...
	@Test
	public void test() {
		assertNotNull("TestRule should have been @Autowired", this.autowiredTestRule);
		...
		assertFalse("@Autowired TestRule should NOT have been applied", this.autowiredTestRule.applied);
	}

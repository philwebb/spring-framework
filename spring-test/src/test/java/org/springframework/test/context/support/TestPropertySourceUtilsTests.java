...
public class TestPropertySourceUtilsTests {
	...
	public void emptyAnnotation() {
		...
		this.expectedException.expectMessage(startsWith("Could not detect default properties file for test"));
		this.expectedException.expectMessage(containsString("EmptyPropertySources.properties"));
	...
	public void extendedEmptyAnnotation() {
		this.expectedException.expect(IllegalStateException.class);
		this.expectedException.expectMessage(startsWith("Could not detect default properties file for test"));
		this.expectedException.expectMessage(containsString("ExtendedEmptyPropertySources.properties"));
	...
	public void locationsAndValueAttributes() {
		this.expectedException.expect(AnnotationConfigurationException.class);
	...
	public void addInlinedPropertiesToEnvironmentWithNullContext() {
		this.expectedException.expect(IllegalArgumentException.class);
		this.expectedException.expectMessage("context");
	...
	public void addInlinedPropertiesToEnvironmentWithContextAndNullInlinedProperties() {
		this.expectedException.expect(IllegalArgumentException.class);
		this.expectedException.expectMessage("inlined");
	...
	public void addInlinedPropertiesToEnvironmentWithNullEnvironment() {
		this.expectedException.expect(IllegalArgumentException.class);
		this.expectedException.expectMessage("environment");
	...
	public void addInlinedPropertiesToEnvironmentWithMalformedUnicodeInValue() {
		this.expectedException.expect(IllegalStateException.class);
		this.expectedException.expectMessage("Failed to load test environment property");
	...
	public void addInlinedPropertiesToEnvironmentWithMultipleKeyValuePairsInSingleInlinedProperty() {
		this.expectedException.expect(IllegalStateException.class);
		this.expectedException.expectMessage("Failed to load exactly one test environment property");

...
public class JsonPathExpectationsHelperTests {
	...
	public void existsForIndefinatePathWithEmptyResults() throws Exception {
		...
		this.exception.expectMessage("No value at JSON path \"" + expression + "\"");
	...
	public void doesNotExistForAnEmptyArray() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected no value at JSON path \"" + expression + "\" but found: []");
	...
	public void doesNotExistForIndefinatePathWithResults() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected no value at JSON path \"" + expression
				+ "\" but found: [{\"name\":\"Bart\"}]");
	...
	public void assertValueIsEmptyForIndefinatePathWithResults() throws Exception {
		String expression = "$.familyMembers[?(@.name == 'Bart')]";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected an empty value at JSON path \"" + expression
				+ "\" but found: [{\"name\":\"Bart\"}]");
	...
	public void assertValueIsEmptyForWhitespace() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected an empty value at JSON path \"" + expression + "\" but found: '    '");
	...
	public void assertValueIsNotEmptyForIndefinatePathWithEmptyResults() throws Exception {
		String expression = "$.familyMembers[?(@.name == 'Dilbert')]";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected a non-empty value at JSON path \"" + expression + "\" but found: []");
	...
	public void hasJsonPathForIndefinatePathWithEmptyResults() {
		String expression = "$.familyMembers[?(@.name == 'Dilbert')]";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("No values for JSON path \"" + expression + "\"");
	...
	public void doesNotHaveEmptyPathForIndefinatePathWithResults() {
		String expression = "$.familyMembers[?(@.name == 'Bart')]";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected no values at JSON path \"" + expression + "\" " +
				"but found: [{\"name\":\"Bart\"}]");
	...
	public void assertValueIsStringForNonString() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected a string at JSON path \"" + expression + "\" but found: true");
	...
	public void assertValueIsNumberForNonNumber() throws Exception {
		String expression = "$.bool";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected a number at JSON path \"" + expression + "\" but found: true");
	...
	public void assertValueIsBooleanForNonBoolean() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected a boolean at JSON path \"" + expression + "\" but found: 5");
	...
	public void assertValueIsArrayForNonArray() throws Exception {
		...
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected an array at JSON path \"" + expression + "\" but found: 'foo'");
	...
	public void assertValueIsMapForNonMap() throws Exception {
		String expression = "$.str";
		this.exception.expect(AssertionError.class);
		this.exception.expectMessage("Expected a map at JSON path \"" + expression + "\" but found: 'foo'");

...
/**
 * Indicates one or more <em>HTTP service clients<em> to import.
 *
...
public @interface ImportHttpServiceClients {
	...
	/**
	 * An optional identifier to indicate that the HTTP service clients are a member of a
	 ...
	 * proxies. If no group is specified, the unique {@link HttpServiceProxyFactory} bean
	 * creates the proxies.
	 */

...
public class ByteArrayHttpMessageConverterTests {
	...
	@Before
	public void setUp() {
		this.converter = new ByteArrayHttpMessageConverter();
	}

	@Test
	public void canRead() {
		assertTrue(this.converter.canRead(byte[].class, new MediaType("application", "octet-stream")));
	}

	@Test
	public void canWrite() {
		assertTrue(this.converter.canWrite(byte[].class, new MediaType("application", "octet-stream")));
		assertTrue(this.converter.canWrite(byte[].class, MediaType.ALL));
	}
	...
	public void read() throws IOException {
		...
		byte[] result = this.converter.read(byte[].class, inputMessage);

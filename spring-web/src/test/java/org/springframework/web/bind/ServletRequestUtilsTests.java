...
public class ServletRequestUtilsTests {
	...
	public void testIntParameter() throws ServletRequestBindingException {
		...
		assertThat((long) 5).isEqualTo((long) ServletRequestUtils.getIntParameter(request, "param1", 6));
		assertThat((long) 5).isEqualTo((long) ServletRequestUtils.getRequiredIntParameter(request, "param1"));

		assertThat((long) 6).isEqualTo((long) ServletRequestUtils.getIntParameter(request, "param2", 6));
		...
		assertThat((long) 6).isEqualTo((long) ServletRequestUtils.getIntParameter(request, "param3", 6));
		assertThatExceptionOfType(ServletRequestBindingException.class).isThrownBy(() ->
	...
	public void testIntParameters() throws ServletRequestBindingException {
		...
		assertThat((long) values.length).isEqualTo((long) 3);
		for (int i = 0; i < array.length; i++) {
			assertThat((long) values[i]).isEqualTo((long) array[i]);
		}
	...
	public void testLongParameter() throws ServletRequestBindingException {
		...
		assertThat(5L).isEqualTo(ServletRequestUtils.getLongParameter(request, "param1", 6L));
		assertThat(5L).isEqualTo((long) ServletRequestUtils.getRequiredIntParameter(request, "param1"));

		assertThat(6L).isEqualTo(ServletRequestUtils.getLongParameter(request, "param2", 6L));
		assertThatExceptionOfType(ServletRequestBindingException.class).isThrownBy(() ->
		...
		assertThat(6L).isEqualTo(ServletRequestUtils.getLongParameter(request, "param3", 6L));
		assertThatExceptionOfType(ServletRequestBindingException.class).isThrownBy(() ->
	...
	public void testLongParameters() throws ServletRequestBindingException {
		...
		assertThat((long) values.length).isEqualTo((long) 2);
	...
	public void testBooleanParameters() throws ServletRequestBindingException {
		...
		assertThat((long) values.length).isEqualTo((long) array.length);
		for (int i = 0; i < array.length; i++) {
			assertThat(values[i]).isEqualTo(array[i]);
		}
	...
	public void testStringParameter() throws ServletRequestBindingException {
		...
		assertThat((Object) ServletRequestUtils.getStringParameter(request, "param3", null)).isNull();
		assertThatExceptionOfType(ServletRequestBindingException.class).isThrownBy(() ->

...
public class ServletWebRequestTests {
	...
	public void parameters() {
		...
		assertThat(request.getParameterValues("param1").length).isEqualTo((long) 1);
		assertThat(request.getParameterValues("param1")[0]).isEqualTo("value1");
		assertThat(request.getParameter("param2")).isEqualTo("value2");
		assertThat(request.getParameterValues("param2").length).isEqualTo((long) 2);
		...
		assertThat(paramMap.size()).isEqualTo((long) 2);
		assertThat(paramMap.get("param1").length).isEqualTo((long) 1);
		assertThat(paramMap.get("param1")[0]).isEqualTo("value1");
		assertThat(paramMap.get("param2").length).isEqualTo((long) 2);

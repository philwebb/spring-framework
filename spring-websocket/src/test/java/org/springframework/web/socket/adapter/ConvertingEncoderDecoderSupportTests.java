...
public class ConvertingEncoderDecoderSupportTests {
	...
	public static class MyTextEncoder extends AbstractConvertingTextEncoder<MyType> {
	}

	public static class MyBinaryEncoder extends AbstractConvertingBinaryEncoder<MyType> {
	}

	public static class MyTextDecoder extends AbstractConvertingTextDecoder<MyType> {
	}

	public static class MyBinaryDecoder extends AbstractConvertingBinaryDecoder<MyType> {
	}
	...
	public static class WithAutowire extends AbstractConvertingTextDecoder<MyType> {
